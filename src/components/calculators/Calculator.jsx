...
const Calculator = () => {
  ...
  //forEach bilan aylanib height ini width ga tenglashtirayapti
  useEffect(() => {
  ...
  const btnClick = (item) => {
    ...
    // quyoshcha bosilgamda temaning o'zgarishi
    if (item.action === BTN_ACTIONS.THEME) {
      document.body.classList.toggle("dark");
    }

    //? bg white qo'sha olmadik
    ...
    // (=) tenglik amallari uchun yozilgan funksiya
  ...
  // raqamlarni hisoblash doskasiga raqamlarni chap tomondan astalik b-n chiqishi
